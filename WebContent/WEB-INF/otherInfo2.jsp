	...
	<div class="row clearfix">
		<div class="col-md-6 column">
			<form role="form">
				...
				<div class="form-group">
					For Nevada residents only. We may contact our existing customers by telephone to offer additional financial products that we believe may be of interest to you. You have the right to opt out of these calls by adding your name to our internal do-not-call list. To opt out of these calls, or for more information about your opt out rights, please contact our customer service department. You can reach us by calling [insert phone nuber], clicking [insert link], or writing to [insert mailing address]. You are being provided this notice under Nevada state law. In addition to contacting [insert institute name], Nevada residents can contact the Nevada Attorney General for more information about your opt out rights by calling 702-486-3132, emailing aginfo@ag.nv.gov, or by writing to: Office of the Attorney General, Nevada Department of Justice, Bureau of Consumer Protection 100 North Carson Street, Carson City, NV 89701-4717
				...
				<button type="submit" class="btn btn-default"><a href="6other information1.html">Previous</a></button>
				<button type="submit" class="btn btn-default"><a href="task14.html">Submit</a></button>
