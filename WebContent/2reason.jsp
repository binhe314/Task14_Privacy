		...
		<div class="col-md-12 column">
			<form role="form" id="form" method="POST" action="reason.do">
				...
				<tbody>
					...
					<tr>
						<td>
							<b> For nonaffiliates to market to you </b> — for all credit card accounts
						</td>
						<td>
							<div class="btn-group">
					...
					<tr>
						<td>
							<b> For nonaffiliates to market to you </b> — for accounts and services endorsed by another organization (e.g., debit card co-branded with a baseball team) “Sponsored Accounts”
						</td>
						<td>
							<div class="btn-group">
					...
					<tr>
						<td>
							<b> For nonaffiliates to market to you </b> — for accounts other than credit card accounts and Sponsored Accounts, such as insurance, investments, deposit and lending
						</td>
						<td>
							<div class="btn-group">
...
function change1(a) {
	var x = (a.value || a.options[a.selectedIndex].value);
	 if(x == "No"){
		...
		document.getElementById("no12").selected = true;
	}  else {
...
function change2(a) {
	var x = (a.value || a.options[a.selectedIndex].value);
	 if(x == "No"){
		...
		document.getElementById("no22").selected = true;
	}  else {
...
function change3(a) {
	var x = (a.value || a.options[a.selectedIndex].value);
	 if(x == "No"){
		...
		document.getElementById("no32").selected = true;
	}  else {
...
function change4(a) {
	var x = (a.value || a.options[a.selectedIndex].value);
	 if(x == "No"){
		...
		document.getElementById("no42").selected = true;
	}  else {
...
function change5(a) {
	var x = (a.value || a.options[a.selectedIndex].value);
	 if(x == "No"){
		...
		document.getElementById("no52").selected = true;
	}  else {
...
function change6(a) {
	var x = (a.value || a.options[a.selectedIndex].value);
	 if(x == "No"){
		...
		document.getElementById("no62").selected = true;
	}  else {
...
function change7(a) {
	var x = (a.value || a.options[a.selectedIndex].value);
	 if(x == "No"){
		...
		document.getElementById("no72").selected = true;
	}  else {
...
function change8(a) {
	var x = (a.value || a.options[a.selectedIndex].value);
	 if(x == "No"){
		...
		document.getElementById("no82").selected = true;
	}  else {
...
function change9(a) {
	var x = (a.value || a.options[a.selectedIndex].value);
	 if(x == "No"){
		...
		document.getElementById("no92").selected = true;
	}  else {
