...
<body>
	...
	function exportXML() {
		...
		xml += ['<Definition>','<GeneralAffiliates>' + affiliates + '</GeneralAffiliates>','<AffiliateMore>' + affiliateMore + '</AffiliateMore>','<AffiliateCompany>' + affiliateCompanies + '</AffiliateCompany>','<Nonaffiliates>' + nonaffiliates + '</Nonaffiliates>','<Jointmarketing>' + jointmarketing + '</Jointmarketing>','</Definition>',''].join('\r\n');
